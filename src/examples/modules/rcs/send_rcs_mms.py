...
if __name__ == '__main__':
    res = storage.upload_rcs_image('../testImage.jpg').json()
    fileId = res['fileId']
            ...
            # 버튼이 포함된 RCS MMS를 발송합니다. 버튼은 최대 2개까지 추가 가능합니다.
            {
                ...
                'rcsOptions': {
                    ...
                    'buttons': [
                        ...
                        , {'buttonType': 'ML', 'buttonName': '지도 위치 표시', 'latitude': '37.280342669603684',
                           'longitude': '127.11824209721874', 'label': '누리고', 'link': 'https://nurigo.net'}
